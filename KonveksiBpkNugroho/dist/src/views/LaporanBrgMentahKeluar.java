 ...
 * @author FADHAL
 */
public class LaporanBrgMentahKeluar extends javax.swing.JFrame {
private DefaultTableModel tabmode;
public final Connection conn = new Koneksi().getKoneksi();
    /**
     * Creates new form LaporanStokBarang
     */
    public LaporanBrgMentahKeluar() {
        initComponents();
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Barang Keluar","Kode Barang","Nama Barang","Supplier","Jumlah","Keterangan","Tanggal"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangMentahKeluar.setModel(tabmode);   
    }
    ...
    public void pencarian(String sql){
        ...
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangMentahKeluar.setModel(tabmode);
        int brs = tabelBarangMentahKeluar.getRowCount();
        for (int i = 0; 1 < brs; i++){
            tabmode.removeRow(1);
        }
        try{
            ...
            while (hasil.next()){
                ...
                String id_bk = hasil.getString("id_brg_mth_keluar");
                ...
                String jumlah = hasil.getString("stok_brg_mth_keluar");
                String keterangan = hasil.getString("ket_brg_mth");
                String tanggal = hasil.getString("tanggal_brg_mth_keluar");
    ...
    private void initComponents() {
        ...
        tabelBarangMentahKeluar = new javax.swing.JTable();
        ...
        labelNama.setText("Laporan Barang Mentah Keluar");
        ...
        tabelBarangMentahKeluar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tabelBarangMentahKeluar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabelBarangMentahKeluar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabelBarangMentahKeluar.setRowHeight(30);
        tabelBarangMentahKeluar.setRowMargin(2);
        tabelBarangMentahKeluar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelBarangMentahKeluarMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelBarangMentahKeluar);
    ...
    private void tabelBarangMentahKeluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBarangMentahKeluarMouseClicked
        int bar = tabelBarangMentahKeluar.getSelectedRow();
        ...
        Date dateValue = null;
        try{
            dateValue = date.parse((String)tabelBarangMentahKeluar.getValueAt(bar, 7));
        } catch (ParseException ex){
            Logger.getLogger(LaporanBrgMentahKeluar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tabelBarangMentahKeluarMouseClicked
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from tb_brg_mth_keluar where tanggal_brg_mth_keluar between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            Connection conn = (Connection)Koneksi.getKoneksi();
            String report = "/reports/LaporanStokBarangMentahKeluar.jasper";
    ...
    private void btnCetakSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakSemuaActionPerformed
        ...
        String dirr = "";
        try {
            String sql = "select id_brg_mth_keluar,kd_brg_mth,nama_brg_mth,supplier,stok_brg_mth_keluar,ket_brg_mth,tanggal_brg_mth_keluar from tb_brg_mth_keluar ";
            Connection conn = (Connection)Koneksi.getKoneksi();
            Statement stmt = conn.createStatement();
            dirr = reportFile.getCanonicalPath()+ "/src/reports/LaporanStokBarangMentahKeluarAll.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanBrgMentahKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabelBarangMentahKeluar;
