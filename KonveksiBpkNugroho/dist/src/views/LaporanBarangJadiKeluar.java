 ...
 * @author FADHAL
 */
public class LaporanBarangJadiKeluar extends javax.swing.JFrame {
private DefaultTableModel tabmode;
public final Connection conn = new Koneksi().getKoneksi();
    /**
     * Creates new form LaporanStokBarang
     */
    public LaporanBarangJadiKeluar() {
        initComponents();
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Barang Keluar","Kode Barang","Nama Barang","Harga Satuan","Jumlah","Keterangan","Tanggal"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangJadiKeluar.setModel(tabmode);   
    }
       
    public void pencarian(String sql){
        Object[] Baris = {"No","ID Barang Keluar","Kode Barang","Nama Barang","Jumlah","Harga Satuan","Keterangan","Tanggal"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangJadiKeluar.setModel(tabmode);
        int brs = tabelBarangJadiKeluar.getRowCount();
        for (int i = 0; 1 < brs; i++){
            tabmode.removeRow(1);
        }
        try{
    ...
    private void initComponents() {
        ...
        tabelBarangJadiKeluar = new javax.swing.JTable();
        ...
        labelNama.setText("Laporan Barang Jadi Keluar");
        ...
        tabelBarangJadiKeluar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tabelBarangJadiKeluar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabelBarangJadiKeluar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabelBarangJadiKeluar.setRowHeight(30);
        tabelBarangJadiKeluar.setRowMargin(2);
        tabelBarangJadiKeluar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelBarangJadiKeluarMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelBarangJadiKeluar);
    ...
    private void tabelBarangJadiKeluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBarangJadiKeluarMouseClicked
        int bar = tabelBarangJadiKeluar.getSelectedRow();
        ...
        Date dateValue = null;
        try{
            dateValue = date.parse((String)tabelBarangJadiKeluar.getValueAt(bar, 7));
        } catch (ParseException ex){
            Logger.getLogger(LaporanBarangJadiKeluar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tabelBarangJadiKeluarMouseClicked
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from tb_brg_jadi_keluar where tanggal_brg_jadi_keluar between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            Connection conn = (Connection)Koneksi.getKoneksi();
            String report = "/reports/LaporanStokBarangJadiKeluar.jasper";
    ...
    private void btnCetakSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakSemuaActionPerformed
        ...
        String dirr = "";
        try {
            String sql = "select id_brg_jadi_keluar,kd_brg_jadi,nama_brg_jadi,stok_brg_jadi_keluar,harga_brg_jadi,ket_brg_jadi,tanggal_brg_jadi_keluar from tb_brg_jadi_keluar";
            Connection conn = (Connection)Koneksi.getKoneksi();
            Statement stmt = conn.createStatement();
            dirr = reportFile.getCanonicalPath()+ "/src/reports/LaporanStokBarangJadiKeluarAll.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanBarangJadiKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabelBarangJadiKeluar;
