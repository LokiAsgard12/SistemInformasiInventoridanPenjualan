 ...
 * @author FADHAL
 */
public class LaporanBarangJadiMasuk extends javax.swing.JFrame {
private DefaultTableModel tabmode;
public final Connection conn = new Koneksi().getKoneksi();
    /**
     * Creates new form LaporanStokBarang
     */
    public LaporanBarangJadiMasuk() {
        initComponents();
    ...
    public void dataTable(){
        Object[] Baris = {"No","ID Barang Masuk","Kode Barang","Nama Barang","Harga Satuan","Jumlah","Keterangan","Tanggal"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangJadiMasuk.setModel(tabmode);   
    }
       
    public void pencarian(String sql){
        Object[] Baris = {"No","ID Barang Masuk","Kode Barang","Nama Barang","Jumlah","Harga Satuan","Keterangan","Tanggal"};
        tabmode = new DefaultTableModel(null, Baris);
        tabelBarangJadiMasuk.setModel(tabmode);
        int brs = tabelBarangJadiMasuk.getRowCount();
        for (int i = 0; 1 < brs; i++){
            tabmode.removeRow(1);
        }
        try{
            ...
            while (hasil.next()){
                ...
                String id_brg = hasil.getString("id_brg_jadi_masuk");
                String kd_brg = hasil.getString("kd_brg_jadi");
                String nama_brg = hasil.getString("nama_brg_jadi");
                String jumlah = hasil.getString("stok_brg_jadi_masuk");
                String harga_brg = hasil.getString("harga_jadi");
                String keterangan = hasil.getString("ket_brg_jadi");
                String tanggal = hasil.getString("tanggal_brg_jadi_masuk");
                String[] data = {no,id_brg,kd_brg,nama_brg,harga_brg,jumlah,keterangan,tanggal};
                tabmode.addRow(data);
    ...
    private void initComponents() {
        ...
        tabelBarangJadiMasuk = new javax.swing.JTable();
        ...
        labelNama.setText("Laporan Barang Jadi Masuk");
        ...
        tabelBarangJadiMasuk.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tabelBarangJadiMasuk.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabelBarangJadiMasuk.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        tabelBarangJadiMasuk.setRowHeight(30);
        tabelBarangJadiMasuk.setRowMargin(2);
        tabelBarangJadiMasuk.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tabelBarangJadiMasukMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tabelBarangJadiMasuk);
    ...
    private void tabelBarangJadiMasukMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBarangJadiMasukMouseClicked
        int bar = tabelBarangJadiMasuk.getSelectedRow();
        ...
        Date dateValue = null;
        try{
            dateValue = date.parse((String)tabelBarangJadiMasuk.getValueAt(bar, 7));
        } catch (ParseException ex){
            Logger.getLogger(LaporanBarangJadiMasuk.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_tabelBarangJadiMasukMouseClicked
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from tb_brg_jadi_masuk where tanggal_brg_jadi_masuk between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            Connection conn = (Connection)Koneksi.getKoneksi();
            String report = "/reports/LaporanStokBarangJadiMasuk.jasper";
    ...
    private void btnCetakSemuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakSemuaActionPerformed
        ...
        String dirr = "";
        try {
            String sql = "select id_brg_jadi_masuk,kd_brg_jadi,nama_brg_jadi,stok_brg_jadi_masuk,harga_jadi,ket_brg_jadi,tanggal_brg_jadi_masuk from tb_brg_jadi_masuk";
            Connection conn = (Connection)Koneksi.getKoneksi();
            Statement stmt = conn.createStatement();
            dirr = reportFile.getCanonicalPath()+ "/src/reports/LaporanStokBarangJadiMasukAll.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanBarangJadiMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tabelBarangJadiMasuk;
